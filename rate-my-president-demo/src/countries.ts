...
export const availableCountries: CountryData[] = [
  ...
  { code: 'EG', name: 'Egypt',           flag: '🇪🇬', leader: 'Abdel Fattah el-Sisi',            avatarSeed: 'AS', avatarColor: '6e2f1a', avatarUrl: '/avatars/abdel-fattah.png' },
  { code: 'TR', name: 'Turkey',          flag: '🇹🇷', leader: 'Recep Tayyip Erdoğan',            avatarSeed: 'RE', avatarColor: '922b21', avatarUrl: '/avatars/recep-tayyip-erdoğan.png' },
  { code: 'SE', name: 'Sweden',          flag: '🇸🇪', leader: 'Ulf Kristersson',                  avatarSeed: 'UK', avatarColor: '1a6b8a', avatarUrl: '/avatars/ulf-kristersson.png' },
  { code: 'NO', name: 'Norway',          flag: '🇳🇴', leader: 'Jonas Gahr Støre',                 avatarSeed: 'JG', avatarColor: '154360', avatarUrl: '/avatars/jonas-gahr-støre.png' },
