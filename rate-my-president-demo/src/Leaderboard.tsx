    ...
    <div className="w-full overflow-hidden rounded-[24px] border border-[oklch(0.28_0.02_250)] bg-[oklch(0.15_0.04_250)] text-[oklch(0.95_0.02_250)] shadow-[0_20px_60px_rgba(0,0,0,0.18)]">
      ...
      {!error && entries.length > 0 && (
        <div className="max-h-[min(64vh,560px)] overflow-auto" ref={scrollContainerRef}>
          <table
            className="min-w-[500px] w-full text-sm"
            role="grid"
          ...
          >
            <thead className="sticky top-0 z-10 border-b border-[oklch(0.28_0.02_250)] bg-[oklch(0.20_0.02_250)]">
              <tr>
                <th
                  className={`px-3 py-3 text-left font-['Inter'] font-600 cursor-pointer transition-colors sm:px-4 ${getSortIndicator('rank').isActive ? 'text-[oklch(0.95_0.02_250)]' : 'text-[oklch(0.75_0.02_250)] hover:text-[oklch(0.95_0.02_250)]'}`}
                ...
                <th
                  className={`px-3 py-3 text-center font-['Inter'] font-600 cursor-pointer transition-colors sm:px-4 ${getSortIndicator('approval').isActive ? 'text-[oklch(0.95_0.02_250)]' : 'text-[oklch(0.75_0.02_250)] hover:text-[oklch(0.95_0.02_250)]'}`}
                ...
                <th className="hidden px-3 py-3 text-center font-['Inter'] font-600 text-[oklch(0.75_0.02_250)] sm:px-4 md:table-cell">
                  Trend
                </th>
                <th
                  className={`hidden px-3 py-3 text-center font-['Inter'] font-600 cursor-pointer transition-colors sm:px-4 lg:table-cell ${getSortIndicator('votes').isActive ? 'text-[oklch(0.95_0.02_250)]' : 'text-[oklch(0.75_0.02_250)] hover:text-[oklch(0.95_0.02_250)]'}`}
              ...
              {isLoading
                ...
                : filteredEntries.map((entry, index) => (
                    ...
                    >
                      ...
                      <td className="px-3 py-3 text-center font-['Inter'] font-700 text-base sm:px-4 sm:py-4">
                        <span
                      ...
                      <td className="hidden px-3 py-3 text-center sm:px-4 sm:py-4 md:table-cell">
                      ...
                      <td className="hidden px-3 py-3 text-center font-['Inter'] text-[oklch(0.75_0.02_250)] sm:px-4 sm:py-4 lg:table-cell">
