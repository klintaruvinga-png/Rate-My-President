...
export default function Leaderboard({
  ...
  const SkeletonRow = () => (
    <tr className="border-b border-[oklch(0.28_0.02_250)] motion-safe:animate-pulse">
      <td className="px-4 py-3 sm:px-4 sm:py-3 text-[oklch(0.75_0.02_250)]">
        <div className="h-3 w-5 sm:h-4 sm:w-6 bg-[oklch(0.28_0.02_250)] rounded" />
      </td>
      <td className="px-4 py-3 sm:px-4 sm:py-3">
      ...
      <td className="px-4 py-3 sm:px-4 sm:py-3 text-right">
        <div className="h-3 w-10 sm:h-4 sm:w-12 bg-[oklch(0.28_0.02_250)] rounded ml-auto" />
      </td>
      <td className="hidden px-4 py-3 sm:px-4 sm:py-3 text-right md:table-cell">
        <div className="h-3 w-6 sm:h-4 sm:w-8 bg-[oklch(0.28_0.02_250)] rounded ml-auto" />
      </td>
      <td className="hidden px-4 py-3 sm:px-4 sm:py-3 text-right lg:table-cell">
  ...
  return (
    <div className="w-full overflow-hidden rounded-[24px] border border-[oklch(0.28_0.02_250)] bg-[oklch(0.15_0.04_250)] text-[oklch(0.95_0.02_250)] shadow-[0_20px_60px_rgba(0,0,0,0.18)]">
      ...
      <div className="flex flex-wrap items-center gap-2 border-b border-[oklch(0.28_0.02_250)] bg-[oklch(0.18_0.03_250)] px-4 py-3 sm:px-6 sm:py-4">
      ...
      {error && (
        <div className="p-6 text-center">
          <p className="text-[oklch(0.55_0.20_25)] font-['Space_Grotesk'] mb-4">{error}</p>
          <button
            onClick={handleRetry}
            className="px-4 py-2 bg-[oklch(0.62_0.18_142)] text-[oklch(0.15_0.04_250)] rounded-lg font-['Space_Grotesk'] font-600 hover:opacity-90 transition-opacity"
          >
            Try Refreshing
          </button>
        </div>
      ...
      {!isLoading && !error && entries.length === 0 && (
        <div className="p-12 text-center">
          <p className="text-[oklch(0.75_0.02_250)] font-['Space_Grotesk'] text-lg mb-2">
            No rankings yet.
          </p>
          <p className="text-[oklch(0.75_0.02_250)] font-['Space_Grotesk'] text-sm">
          ...
          >
            <thead className="sticky top-0 z-10 border-b border-[oklch(0.28_0.02_250)] bg-[oklch(0.20_0.02_250)]">
              <tr>
                ...
                <th className="hidden px-4 py-3 text-center font-['Inter'] font-600 text-[oklch(0.75_0.02_250)] sm:px-4 sm:py-3 md:table-cell">
                  Trend
                </th>
                <th
                  className={`hidden px-4 py-3 text-center font-['Inter'] font-600 cursor-pointer transition-colors sm:px-4 sm:py-3 lg:table-cell ${getSortIndicator('votes').isActive ? 'text-[oklch(0.95_0.02_250)]' : 'text-[oklch(0.75_0.02_250)] hover:text-[oklch(0.95_0.02_250)]'}`}
            ...
            <tbody>
              {isLoading
                ...
                : filteredEntries.map((entry, index) => (
                    ...
                    >
                      <td className="w-12 px-4 py-3 font-['Inter'] font-600 text-[oklch(0.75_0.02_250)] sm:px-4 sm:py-3">
                        #{entry.rank}
                      </td>
                      <td
                        className={`px-4 py-3 sm:px-4 sm:py-3 ${onLeaderClick ? 'cursor-pointer' : ''}`}
                      ...
                      <td className="px-4 py-3 text-center font-['Inter'] font-700 text-sm sm:text-base sm:px-4 sm:py-3">
                        <span
                      ...
                      <td className="hidden px-4 py-3 text-center sm:px-4 sm:py-3 md:table-cell">
                      ...
                      <td className="hidden px-4 py-3 text-center font-['Inter'] text-[oklch(0.75_0.02_250)] sm:px-4 sm:py-3 lg:table-cell">
      ...
      {!isLoading && lastUpdated && (
        <div className="border-t border-[oklch(0.28_0.02_250)] px-4 py-3 text-xs font-['Inter'] text-[oklch(0.75_0.02_250)] sm:px-6 sm:py-4">
          Updated: {lastUpdated}
        </div>
      )}
    </div>
