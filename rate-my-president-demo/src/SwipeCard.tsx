    ...
    return (
      <div className="flex flex-col relative overflow-hidden rounded-t-[20px]">
        ...
        <div className="relative h-[300px] w-full shrink-0 sm:h-[340px] md:h-[360px]">
          ...
          <div className="absolute inset-0 bg-[linear-gradient(to_top,oklch(0.25_0.04_250)_0%,oklch(0.25_0.04_250_/_0.85)_25%,oklch(0.25_0.04_250_/_0.5)_50%,transparent_100%)]" />
